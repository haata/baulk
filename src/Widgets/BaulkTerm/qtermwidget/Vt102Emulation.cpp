...
switch (token)
{
	...
	case TY_ESC_DE('3'    ) : /* Double height line, top half    */ 
		...
		_currentScreen->setLineProperty( LINE_DOUBLEHEIGHT, true );            break;
	...
	case TY_ESC_DE('5'    ) : /* Single width, single height line*/
		...
		_currentScreen->setLineProperty( LINE_DOUBLEHEIGHT, false );           break;
	...
	case TY_CSI_PR('l',1047) : _screen[1]->clearEntireScreen(); 
				     resetMode                       (MODE_AppScreen); break; //XTERM
	...
	case TY_CSI_PR('h',1049) :    saveCursor(); 
				   _screen[1]->clearEntireScreen(); 
				       setMode                       (MODE_AppScreen); break; //XTERM
